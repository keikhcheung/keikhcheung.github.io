...
# Problem
As digital services emerge, every day we create a huge amount of data across various providers.📱💻⌚️📡 Yet, we don't know what has been written on our names behind their gates. Why are we——the data generators——*kept in the dark from our own data* footprints online?
