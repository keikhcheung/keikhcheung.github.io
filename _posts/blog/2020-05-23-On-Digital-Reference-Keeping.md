...
Update Feb 2021: I have now moved to [Obsidian](https://obsidian.md/){:target="_blank"} and [Foam](https://foambubble.github.io/foam/){:target="_blank"} for my reference keeping. They are both based on Markdown files and thus are not as atomic or flexible as the outliner counterparts Roam or [RemNote](https://www.remnote.io/){:target="_blank"}. However, that also means better ownership control, storage of preference and pipelined Web publishing. Both Obsidian and Foam have great community support and the latter is [open-source](https://github.com/foambubble/foam){:target="_blank"}, too!
